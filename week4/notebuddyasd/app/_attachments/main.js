$('#newNote').on('pageinit', function (){
	...
	function storeData() {
		...
		$.couch.db("notebuddyasd").saveDoc(notes, {
...
$('#notes').on("pageinit", function() {
	$.couch.db("notebuddyasd").view("notebuddy/notes", {
		success: function(data) {
			$("#noteList").empty();
	...
	function titleItemLinks(id, rev) {
		...
		editLink.on("click", function() {
			$.couch.db("notebuddyasd").openDoc(id, {
			    success: function(note) {
					...
					editSubmit.on("click", function(){
						...
						$.couch.db("notebuddyasd").saveDoc(note, {
						    success: function(data) {
						        console.log(data);
						    }
						});	
	...
	function deleteNote(id, rev) {
		...
		$.couch.db("notebuddyasd").removeDoc(doc, {
			success: function(data) {
				console.log(data);
